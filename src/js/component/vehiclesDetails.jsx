                ...
                <div className="d-flex justify-content-center p-3">
                    <figure className="text-white d-flex">
                        ...
                        <div className="ms-5">
                            ...
                            <div>
                                <p>vehicle class: {store.detailed?.properties?.vehicle_class}</p>
                                ...
                                <p>max atmosphering speed: {store.detailed?.properties?.max_atmosphering_speed}</p>
                                <p>cargo capacity: {store.detailed?.properties?.cargo_capacity}</p>
